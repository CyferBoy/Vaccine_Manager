...
object ReceiptFormatter {
    ...
    fun drawClinicHeader(context: Context, canvas: Canvas, paint: Paint, yPos: Float): Float {
        var currentY = yPos
    ...
    fun drawPatientInfoBar(canvas: Canvas, paint: Paint, patient: Patient, yPos: Float): Float {
        var currentY = yPos
